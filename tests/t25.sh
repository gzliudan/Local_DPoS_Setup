#!/bin/bash
# T25 — filling S4's nonce gap at the new floor promotes the parked 700 gwei
...
MARKER=/tmp/g2500-t10-hashes
SURVIVOR_WEI=700000000000    # 700 gwei — strictly above the 625 gwei floor

# the pre side (T10) must have seeded the survivor on this chain
[ -f "$MARKER" ] || skip_case "no T10 pre side on this chain (no $MARKER)"
