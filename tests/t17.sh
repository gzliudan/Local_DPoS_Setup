#!/bin/bash
# T17 — a legacy creation above the tier floor seals on the pre-fork tier (12.5 gwei).
# (The other half of this tx pair is T50.)
source "$(dirname "$0")/gas2500x-lib.sh"
begin_case "T17" "seal a legacy creation above the tier floor (pre-fork tier)" 2.1
